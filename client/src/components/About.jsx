  ...
  return (
    <div id="about" className='px-10 py-10 bg-[url("./assets/banklogo.png")] md:bg-no-repeat bg-contain bg-right'>
        <div className=' md:w-[60%] md-[80%]'>
            <h3 className='text-white font-bold text-2xl'>______ About us</h3>
            <div className='mt-5'>
                <h2 className='text-4xl font-semibold text-white'>We are building a stronger community — together.</h2>
        ...
        <div className='md:w-[60%] md-[80%]'>
        <h3 className='text-white font-bold text-2xl mt-10'>______Our Purpose</h3>
            <div className='mt-5'>
                <h2 className='text-4xl font-semibold text-white'>Making a difference in people's lives.</h2>
